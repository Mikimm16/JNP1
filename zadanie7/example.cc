...
int main() {
    ...
    create_BMP("constant.bmp", width, height, constant(Colors::Vermilion));
    create_BMP("rotate.bmp", width, height, rotate(vs, M_PI / 4.));
    create_BMP("translate.bmp", width, height, translate(vs, Vector(100., 0.)));
    create_BMP("scale.bmp", width, height, scale(vs, 2.));
    create_BMP("circle.bmp", width, height,
